@echo off
rem Starts Analyze-Diagnostics.ps1 from this folder. Bypass applies to this one process only,
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0Analyze-Diagnostics.ps1" %*
