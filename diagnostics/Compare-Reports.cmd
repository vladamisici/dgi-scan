@echo off
rem Starts Compare-Reports.ps1 from this folder. Bypass applies to this one process only,
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0Compare-Reports.ps1" %*
