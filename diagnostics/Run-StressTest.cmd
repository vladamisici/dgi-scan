@echo off
rem Starts Run-StressTest.ps1 from this folder. Bypass applies to this one process only,
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0Run-StressTest.ps1" %*
